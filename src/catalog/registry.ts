...
/**
 * Add a block by creating `src/catalog/blocks/<category>/<id>.ts` that
 * exports `const block = { ... } satisfies Block`.
...
export const blocks: Block[] = Object.values(modules).sort(sortBlocks)
