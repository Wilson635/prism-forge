    ...
    <section className="mx-auto max-w-7xl bg-white px-6 py-16 font-['Manrope',sans-serif] text-slate-900">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <motion.div
          ...
          whileHover={{ y: -4 }}
          className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-slate-200/80 bg-slate-50 p-8 transition-all hover:border-slate-300 hover:shadow-xl lg:col-span-1"
        >
